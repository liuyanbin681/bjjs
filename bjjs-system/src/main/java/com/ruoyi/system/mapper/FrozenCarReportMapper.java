 ...
 * @date 2019-08-17
 */
public interface FrozenCarReportMapper 
{
	/**
     * 查询到站冻车上报信息
     * 
     ...
     * @return 结果
     */
	public int deleteFrozenCarReportById(Integer fdReportId);
	
	/**
     * 批量删除到站冻车上报
     * 
     * @param fdReportIds 需要删除的数据ID
     * @return 结果
     */
	public int deleteFrozenCarReportByIds(String[] fdReportIds);
